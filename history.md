...
- Build command to run from inside the staged `rpi5-install` root: `sudo tar --owner=root --group=root --numeric-owner -czvf ~/manet-new/MANET/install_packages/rpi5-install.tar.gz .`
